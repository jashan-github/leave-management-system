...
$sqlUsers = "SELECT * FROM department";
    ...
    <div class="container">
        <div class="col-md-11">
            <div class="line" style="text-align: right;">
                <a href="add-departments.php" class="btn btn-primary"> Add Department</a>
            </div><br>
                ...
                <table class="table display responsive-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="edit-departments.php?id=<?php echo $values['id']?>" class="btn btn-primary">Edit
                                </a>
                                <a onclick="return confirm('Are you sure you want to delete this item?');"
                                    href="delete-departments.php?id=<?php echo $values['id'] ?>"
